...
- ~~Test `hsd_load` when error argument is omitted and file doesn't exist~~ ✅ (test_edge_cases_io_suite)
- ~~Test unclosed quotes and malformed complex numbers~~ ✅ (test_edge_cases_io_suite)
- ~~Test hash table rehash under high load (>100 entries)~~ ✅ (test_hash_table_suite + test_edge_cases_io_suite)
